	...
	return (
		<>
			<button
				...
				className='group inline-flex min-w-48 items-stretch justify-between gap-2 rounded-md border bg-background p-1.5 text-sm text-muted-foreground transition-colors hocus:bg-accent/10 hocus:text-accent-foreground dark:hocus:text-accent-foreground'
			>
